...
Thank you for considering a contribution to MAO.
...
in MAO, future MAO releases, and future commercial versions or hosted offerings
such as MAO Cloud, MAO Team, or MAO Enterprise.
...
MAO may introduce a Contributor License Agreement (CLA) or Developer Certificate
...
must be compatible with MAO's source-available licensing model. Update
...
Do not use MAO, MAO OS, MAO Cloud, or project logos in a way that suggests your
