export const en = {
  ...
  agentForm: {
    ...
    obsidianNotesSubdirHint: "Folder inside the vault that Seiton creates and updates. Usually keep this as MAO. Use . if you want organization / agents / tasks directly at the vault root. You do not need to create this folder first; Seiton creates it on organization save or task start.",
  ...
  inspector: {
    ...
    permissionPolicy: "Permission Policy",
    edit: "Change (Edit)",
    askExecClaudeHint: "Permission requests from claude are confirmed via the Seiton approval dialog.",
  ...
  setup: {
    ...
    installGuide: "Click Install to let Seiton run the command for you, or Copy to run it manually in Terminal.",
    maoWorkspaceHint: "When tasks run, Seiton creates a temporary .mao/ folder inside each agent's workingDirectory for task files and signals. If it is a git repo, .mao/ is appended to .gitignore automatically.",
    missingRequired: (n: number) => `${n} required tool(s) are missing. Seiton may not start correctly until you install them.`,
